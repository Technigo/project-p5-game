...
if (category === 'hair color') {
    ...
    currentQuestion = {
      attribute: value, //olika värden inom samma kategori, därför sätter vi värde här istället
...
const checkQuestion = () => {
  ...
  const charactersToRender = charactersInPlay.filter((characters) => {
  return characters.value === currentQuestion.value
...
const checkMyGuess = (suspect) => {
  ...
  if(suspect === secret.name)
    ...
    {winOrLoseText.innerHTML =`You guessed ${suspect} and it was correct! :)`}
    else 
    //{console.log(`Your quess was wrong`)}
    {winOrLoseText.innerHTML =`You guessed ${suspect} and it was wrong! :(`}
